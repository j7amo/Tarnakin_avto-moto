...
const sliderImages = [
  {
    mainSrcStandard: '/img/desktop-slide-1-1x.jpg',
    mainSrcRetina: '/img/desktop-slide-1-2x.jpg',
    alt: 'Экстерьер автомобиля Марпех на фоне небоскрёбов',
    miniatureSrcStandard: '/img/desktop-slide-min-1-1x.jpg',
    miniatureSrcRetina: '/img/desktop-slide-min-1-2x.jpg',
    miniatureAlt:
      'Экстерьер автомобиля Марпех на фоне небоскрёбов. Уменьшенное изображение.',
  },
  {
    mainSrcStandard: '/img/desktop-slide-2-1x.jpg',
    mainSrcRetina: '/img/desktop-slide-2-2x.jpg',
    alt: 'Интерьер автомобиля Марпех',
    miniatureSrcStandard: '/img/desktop-slide-min-2-1x.jpg',
    miniatureSrcRetina: '/img/desktop-slide-min-2-2x.jpg',
    miniatureAlt: 'Интерьер автомобиля Марпех. Уменьшенное изображение.',
  },
  {
    mainSrcStandard: '/img/desktop-slide-3-1x.jpg',
    mainSrcRetina: '/img/desktop-slide-3-2x.jpg',
    alt: 'Спидометр автомобиля Марпех крупным планом',
    miniatureSrcStandard: '/img/desktop-slide-min-3-1x.jpg',
    miniatureSrcRetina: '/img/desktop-slide-min-3-2x.jpg',
    miniatureAlt:
